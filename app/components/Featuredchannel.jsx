      ...
      <div className="absolute bottom-0 w-full h-[40%] bg-gradient-to-t from-black/70 to-transparent">
        <div className="h-full flex items-end justify-center pb-2">
          <div className="text-center">
            <img className="mx-auto mb-1 w-10 h-10 " src={channel.avatar_60_url} alt={channel.screenname} />
            <h3 className="text-white font-bold text-sm">{channel.screenname}</h3>
          </div>
        </div>
      </div>
    </a>
...
const Featuredchannel = ({ data }) => {
  ...
  return (
    <div className="px-4 mb-14">
      <h3 className="text-xl md:text-2xl font-semibold mb-4">Featured Channels</h3>
